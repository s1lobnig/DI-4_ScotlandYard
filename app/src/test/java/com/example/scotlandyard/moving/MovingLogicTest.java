...
public class MovingLogicTest {
    ...
    public static Iterable data() {
        return Arrays.asList(new Object[][]{
                ...
                {"test", false, BUS[0], Points.POINTS[3], 1, "TEST", 4, false, false, 2, R.drawable.ticket_red, 2, 3, 5, 6, null, R.drawable.bus, R.drawable.ticket_red, R.drawable.ticket_red, false, false, Points.POINTS[15], null, R.drawable.bus, R.drawable.ticket_red, Points.POINTS[3], Points.POINTS[15], BUS[0], R.drawable.bus, R.drawable.ticket_red, Points.POINTS[3], Points.POINTS[15], BUS[0], 2, 3},
                {"test", false, BY_FOOT[0], Points.POINTS[1], 1, "TEST", 4, false, false, 0, R.drawable.ticket_yellow, 0, 1, 1, 2, null, R.drawable.pedestrian, R.drawable.ticket_yellow, R.drawable.ticket_yellow, false, false, Points.POINTS[0], null, R.drawable.pedestrian, R.drawable.ticket_yellow, Points.POINTS[1], Points.POINTS[0], BY_FOOT[0], R.drawable.pedestrian, R.drawable.ticket_yellow, Points.POINTS[1], Points.POINTS[0], BY_FOOT[0], 0, 1},
                {"test", false, BICYCLE[0], Points.POINTS[3], 1, "TEST", 4, false, false, 1, R.drawable.ticket_orange, 3, 4, 7, 8, null, R.drawable.bicycle, R.drawable.ticket_orange, R.drawable.ticket_orange, false, false, Points.POINTS[0], null, R.drawable.bicycle, R.drawable.ticket_orange, Points.POINTS[3], Points.POINTS[0], BICYCLE[0], R.drawable.bicycle, R.drawable.ticket_orange, Points.POINTS[3], Points.POINTS[0], BICYCLE[0], 3, 4},
                {"test", false, BUS[0], Points.POINTS[15], 1, "TEST", 4, false, false, 2, R.drawable.ticket_red, 2, 3, 5, 6, null, R.drawable.bus, R.drawable.ticket_red, R.drawable.ticket_red, false, false, Points.POINTS[3], null, R.drawable.bus, R.drawable.ticket_red, Points.POINTS[15], Points.POINTS[3], BUS[0], R.drawable.bus, R.drawable.ticket_red, Points.POINTS[15], Points.POINTS[3], BUS[0], 2, 3},
                // Tests for entries and black ticket
                {"test", true, BY_FOOT[0], Points.POINTS[0], 2, "TEST", 4, false, false, 0, R.drawable.ticket_yellow, 0, 1, 1, 2, new PositionEntry(3, 1), R.drawable.pedestrian, R.drawable.ticket_yellow, R.drawable.ticket_black, false, false, Points.POINTS[1], null, R.drawable.pedestrian, R.drawable.ticket_black, Points.POINTS[0], Points.POINTS[1], BY_FOOT[0], R.drawable.pedestrian, R.drawable.ticket_black, Points.POINTS[0], Points.POINTS[1], BY_FOOT[0], 0, 1},
                {"test", true, BY_FOOT[0], Points.POINTS[0], 4, "TEST", 4, false, false, 0, R.drawable.ticket_yellow, 0, 1, 1, 2, new TicketEntry(5, R.drawable.ticket_yellow), R.drawable.pedestrian, R.drawable.ticket_yellow, R.drawable.ticket_black, false, false, Points.POINTS[1], null, R.drawable.pedestrian, R.drawable.ticket_black, Points.POINTS[0], Points.POINTS[1], BY_FOOT[0], R.drawable.pedestrian, R.drawable.ticket_black, Points.POINTS[0], Points.POINTS[1], BY_FOOT[0], 0, 1},
                {"test", true, BY_FOOT[0], Points.POINTS[0], 6, "TEST", 4, false, false, 0, R.drawable.ticket_yellow, 0, 1, 1, 2, new PositionEntry(7, 1), R.drawable.pedestrian, R.drawable.ticket_yellow, R.drawable.ticket_black, false, false, Points.POINTS[1], null, R.drawable.pedestrian, R.drawable.ticket_black, Points.POINTS[0], Points.POINTS[1], BY_FOOT[0], R.drawable.pedestrian, R.drawable.ticket_black, Points.POINTS[0], Points.POINTS[1], BY_FOOT[0], 0, 1},
                {"test", true, BY_FOOT[0], Points.POINTS[0], 11, "TEST", 4, false, false, 0, R.drawable.ticket_yellow, 0, 1, 1, 2, new PositionEntry(12, 1), R.drawable.pedestrian, R.drawable.ticket_yellow, R.drawable.ticket_black, false, false, Points.POINTS[1], null, R.drawable.pedestrian, R.drawable.ticket_black, Points.POINTS[0], Points.POINTS[1], BY_FOOT[0], R.drawable.pedestrian, R.drawable.ticket_black, Points.POINTS[0], Points.POINTS[1], BY_FOOT[0], 0, 1},
    ...
    public void testRoadMapEntry() {
        if (player.isMrX()) {
            Assert.assertEquals(resultingEntry, MovingLogic.getRoadMapEntry(this.round, Points.POINTS[route.getEndPoint() - 1], ticket));
        }
    }
