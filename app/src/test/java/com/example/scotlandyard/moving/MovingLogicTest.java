...
public class MovingLogicTest {
    ...
    public static Iterable data() {
        return Arrays.asList(new Object[][]{
                 ...
                 */
                // genreal tests
                {"test", false, BY_FOOT[0], FIELDS[0], 1, "TEST", 4, false, false, 0, R.drawable.ticket_yellow, 0, 1, 1, 2, null, R.drawable.pedestrian, R.drawable.ticket_yellow, R.drawable.ticket_yellow, false, false, FIELDS[1], null, R.drawable.pedestrian, R.drawable.ticket_yellow, FIELDS[0], FIELDS[1], BY_FOOT[0], R.drawable.pedestrian, R.drawable.ticket_yellow, FIELDS[0], FIELDS[1], BY_FOOT[0], 0, 1},
                {"test", false, BICYCLE[0], FIELDS[0], 1, "TEST", 4, false, false, 1, R.drawable.ticket_orange, 3, 4, 7, 8, null, R.drawable.bicycle, R.drawable.ticket_orange, R.drawable.ticket_orange, false, false, FIELDS[3], null, R.drawable.bicycle, R.drawable.ticket_orange, FIELDS[0], FIELDS[3], BICYCLE[0], R.drawable.bicycle, R.drawable.ticket_orange, FIELDS[0], FIELDS[3], BICYCLE[0], 3, 4},
                {"test", false, BUS[0], FIELDS[3], 1, "TEST", 4, false, false, 2, R.drawable.ticket_red, 2, 3, 5, 6, null, R.drawable.bus, R.drawable.ticket_red, R.drawable.ticket_red, false, false, FIELDS[15], null, R.drawable.bus, R.drawable.ticket_red, FIELDS[3], FIELDS[15], BUS[0], R.drawable.bus, R.drawable.ticket_red, FIELDS[3], FIELDS[15], BUS[0], 2, 3},
                {"test", false, BY_FOOT[0], FIELDS[1], 1, "TEST", 4, false, false, 0, R.drawable.ticket_yellow, 0, 1, 1, 2, null, R.drawable.pedestrian, R.drawable.ticket_yellow, R.drawable.ticket_yellow, false, false, FIELDS[0], null, R.drawable.pedestrian, R.drawable.ticket_yellow, FIELDS[1], FIELDS[0], BY_FOOT[0], R.drawable.pedestrian, R.drawable.ticket_yellow, FIELDS[1], FIELDS[0], BY_FOOT[0], 0, 1},
                {"test", false, BICYCLE[0], FIELDS[3], 1, "TEST", 4, false, false, 1, R.drawable.ticket_orange, 3, 4, 7, 8, null, R.drawable.bicycle, R.drawable.ticket_orange, R.drawable.ticket_orange, false, false, FIELDS[0], null, R.drawable.bicycle, R.drawable.ticket_orange, FIELDS[3], FIELDS[0], BICYCLE[0], R.drawable.bicycle, R.drawable.ticket_orange, FIELDS[3], FIELDS[0], BICYCLE[0], 3, 4},
                {"test", false, BUS[0], FIELDS[15], 1, "TEST", 4, false, false, 2, R.drawable.ticket_red, 2, 3, 5, 6, null, R.drawable.bus, R.drawable.ticket_red, R.drawable.ticket_red, false, false, FIELDS[3], null, R.drawable.bus, R.drawable.ticket_red, FIELDS[15], FIELDS[3], BUS[0], R.drawable.bus, R.drawable.ticket_red, FIELDS[15], FIELDS[3], BUS[0], 2, 3},
                // Tests for entries and black ticket
                {"test", true, BY_FOOT[0], FIELDS[0], 2, "TEST", 4, false, false, 0, R.drawable.ticket_yellow, 0, 1, 1, 2, new PositionEntry(3, 1), R.drawable.pedestrian, R.drawable.ticket_yellow, R.drawable.ticket_black, false, false, FIELDS[1], null, R.drawable.pedestrian, R.drawable.ticket_black, FIELDS[0], FIELDS[1], BY_FOOT[0], R.drawable.pedestrian, R.drawable.ticket_black, FIELDS[0], FIELDS[1], BY_FOOT[0], 0, 1},
                {"test", true, BY_FOOT[0], FIELDS[0], 4, "TEST", 4, false, false, 0, R.drawable.ticket_yellow, 0, 1, 1, 2, new TicketEntry(5, R.drawable.ticket_yellow), R.drawable.pedestrian, R.drawable.ticket_yellow, R.drawable.ticket_black, false, false, FIELDS[1], null, R.drawable.pedestrian, R.drawable.ticket_black, FIELDS[0], FIELDS[1], BY_FOOT[0], R.drawable.pedestrian, R.drawable.ticket_black, FIELDS[0], FIELDS[1], BY_FOOT[0], 0, 1},
                {"test", true, BY_FOOT[0], FIELDS[0], 6, "TEST", 4, false, false, 0, R.drawable.ticket_yellow, 0, 1, 1, 2, new PositionEntry(7, 1), R.drawable.pedestrian, R.drawable.ticket_yellow, R.drawable.ticket_black, false, false, FIELDS[1], null, R.drawable.pedestrian, R.drawable.ticket_black, FIELDS[0], FIELDS[1], BY_FOOT[0], R.drawable.pedestrian, R.drawable.ticket_black, FIELDS[0], FIELDS[1], BY_FOOT[0], 0, 1},
                {"test", true, BY_FOOT[0], FIELDS[0], 11, "TEST", 4, false, false, 0, R.drawable.ticket_yellow, 0, 1, 1, 2, new PositionEntry(12, 1), R.drawable.pedestrian, R.drawable.ticket_yellow, R.drawable.ticket_black, false, false, FIELDS[1], null, R.drawable.pedestrian, R.drawable.ticket_black, FIELDS[0], FIELDS[1], BY_FOOT[0], R.drawable.pedestrian, R.drawable.ticket_black, FIELDS[0], FIELDS[1], BY_FOOT[0], 0, 1},
                {"test", true, TAXI_DRAGAN[0], FIELDS[9], 11, "TEST", 4, false, false, 3, R.drawable.ticket_blue, 0, 1, 1, 2, new PositionEntry(12, 39), R.drawable.taxi, R.drawable.ticket_blue, R.drawable.ticket_black, false, false, FIELDS[39], null, R.drawable.taxi, R.drawable.ticket_black, FIELDS[9], FIELDS[39], TAXI_DRAGAN[0], R.drawable.taxi, R.drawable.ticket_black, FIELDS[9], FIELDS[39], TAXI_DRAGAN[0], 0, 1},
                // tests for goBack and randomRoute
                {"test", false, BY_FOOT[0], FIELDS[0], 1, "TEST", 4, false, false, 0, R.drawable.ticket_yellow, 0, 1, 1, 2, null, R.drawable.pedestrian, R.drawable.ticket_yellow, R.drawable.ticket_yellow, true, false, FIELDS[1], new ValidatedRoute(BICYCLE[0], true, 1), R.drawable.bicycle, R.drawable.ticket_yellow, FIELDS[0], FIELDS[3], BICYCLE[0], R.drawable.bicycle, R.drawable.ticket_yellow, FIELDS[0], FIELDS[3], BICYCLE[0], 3, 4},
                {"test", false, BY_FOOT[1], FIELDS[3], 1, "TEST", 4, false, false, 0, R.drawable.ticket_yellow, 0, 1, 1, 2, null, R.drawable.pedestrian, R.drawable.ticket_yellow, R.drawable.ticket_yellow, true, false, FIELDS[1], new ValidatedRoute(BICYCLE[0], true, 1), R.drawable.bicycle, R.drawable.ticket_yellow, FIELDS[3], FIELDS[0], BICYCLE[0], R.drawable.bicycle, R.drawable.ticket_yellow, FIELDS[3], FIELDS[0], BICYCLE[0], 3, 4},
                {"test", false, BY_FOOT[1], FIELDS[3], 1, "TEST", 4, false, false, 0, R.drawable.ticket_yellow, 0, 1, 1, 2, null, R.drawable.pedestrian, R.drawable.ticket_yellow, R.drawable.ticket_yellow, true, false, FIELDS[1], new ValidatedRoute(BUS[0], true, 2), R.drawable.bus, R.drawable.ticket_yellow, FIELDS[3], FIELDS[15], BUS[0], R.drawable.bus, R.drawable.ticket_yellow, FIELDS[3], FIELDS[15], BUS[0], 2, 3},
                {"test", false, BICYCLE[0], FIELDS[0], 1, "TEST", 4, false, false, 1, R.drawable.ticket_orange, 3, 4, 7, 8, null, R.drawable.bicycle, R.drawable.ticket_orange, R.drawable.ticket_orange, true, false, FIELDS[3], new ValidatedRoute(BY_FOOT[0], true, 0), R.drawable.pedestrian, R.drawable.ticket_orange, FIELDS[0], FIELDS[1], BY_FOOT[0], R.drawable.pedestrian, R.drawable.ticket_orange, FIELDS[0], FIELDS[1], BY_FOOT[0], 0, 1},
                {"test", true, BY_FOOT[9], FIELDS[9], 1, "TEST", 4, false, false, 0, R.drawable.ticket_yellow, 0, 1, 1, 2, new TicketEntry(2, R.drawable.ticket_yellow), R.drawable.pedestrian, R.drawable.ticket_yellow, R.drawable.ticket_black, true, false, FIELDS[8], new ValidatedRoute(TAXI_DRAGAN[0], true, 3), R.drawable.taxi, R.drawable.ticket_black, FIELDS[9], FIELDS[39], TAXI_DRAGAN[0], R.drawable.taxi, R.drawable.ticket_black, FIELDS[9], FIELDS[39], TAXI_DRAGAN[0], 0, 1},

                {"test", false, BY_FOOT[0], FIELDS[0], 1, "TEST", 4, false, false, 0, R.drawable.ticket_yellow, 0, 1, 1, 2, null, R.drawable.pedestrian, R.drawable.ticket_yellow, R.drawable.ticket_yellow, false, true, FIELDS[1], null, R.drawable.pedestrian, R.drawable.ticket_yellow, FIELDS[0], FIELDS[1], BY_FOOT[0], R.drawable.pedestrian, R.drawable.ticket_yellow, FIELDS[0], FIELDS[0], BY_FOOT[0], 1, 2},
        });
    }
    ...
    public void testRoadMapEntry() {
        if (player.isMrX()) {
            Assert.assertEquals(resultingEntry, MovingLogic.getRoadMapEntry(this.round, FIELDS[route.getEndPoint() - 1], ticket));
        }
    }
